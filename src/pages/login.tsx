...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <Particle  />
            <div className="flex justify-center items-center bg-gradient-to-r from-blue-500 to-cyan-400 h-screen z-2">
                <div className="relative h-3/4 w-3/4 shadow-2xl rounded-xl bg-white py-6 px-4">
                    <div className="h-full">
                        <div className="grid grid-cols-2 h-full">

                            <div className="flex flex-col justify-center items-center">
                                <p className="antialiased text-3xl font-bold font-mono text-center text-blue-500">Welcome to our Office Hours Scheduling Application!</p>
                                <Image src={loginPageImage} alt='Welcome' />
                            </div>

                            <div className="relative flex flex-col justify-center items-center mx-6 rounded-lg shadow-xl gap-10">
                                ...
                                <div className="font-mono text-xl text-center">
                                    Join AUI Professors and Students:
                                </div>
                                <div className="flex flex-col justify-center items-center">
                                    ...
                                    <p className="mt-1 font-bold text-blue-400 font-mono text-center">Join Us!</p>
                                </div>
                            </div>
                        </div>
                    </div>
